package com.hyf.myspringboot.Realm;

import com.hyf.myspringboot.mapper.RoleMapper;
import com.hyf.myspringboot.mapper.UserMapper;
import com.hyf.myspringboot.mapper.UserRoleMapper;
import com.hyf.myspringboot.pojo.Role;
...
public class AuthRealm extends AuthorizingRealm {
    ...
    protected AuthenticationInfo doGetAuthenticationInfo(AuthenticationToken token)
        ...
        //principal 身份=用户名
        User user = Optional.ofNullable(userMapper.findUserByName(principal)).orElseThrow(UnknownAccountException::new);
        if (user.getLocked()) {
